 ...
 *     },
 * }
 * @psalm-type DiscogsApiConfig = array{
 *     user_agent?: scalar|Param|null, // User-Agent string for API requests. Must be unique to your application.
 *     base_url?: scalar|Param|null, // Discogs API base URL. // Default: "https://api.discogs.com"
 *     timeout?: int|Param, // HTTP request timeout in seconds. // Default: 30
 *     user_token?: array{
 *         token?: scalar|Param|null, // Default: null
 *     },
 *     oauth1?: array{
 *         consumer_key?: scalar|Param|null, // Default: null
 *         consumer_secret?: scalar|Param|null, // Default: null
 *         token?: scalar|Param|null, // Default: null
 *         token_secret?: scalar|Param|null, // Default: null
 *         callback_url?: scalar|Param|null, // Default: null
 *     },
 *     cache?: array{
 *         enabled?: bool|Param, // Default: false
 *         pool?: scalar|Param|null, // Default: "cache.app"
 *         ttl?: array{
 *             artists?: int|Param, // Default: 3600
 *             releases?: int|Param, // Default: 1800
 *             masters?: int|Param, // Default: 3600
 *             labels?: int|Param, // Default: 3600
 *             collection?: int|Param, // Default: 300
 *             wantlist?: int|Param, // Default: 300
 *             marketplace?: int|Param, // Default: 60
 *         },
 *     },
 *     enable_rate_limit_header?: bool|Param, // Track rate limit headers. // Default: true
 *     retry_on_rate_limit?: bool|Param, // Auto-retry after rate limit resets. // Default: false
 *     max_retries?: int|Param, // Maximum number of retries for failed requests. // Default: 3
 *     dispatch_events?: bool|Param, // Enable Symfony event dispatching for API calls. // Default: false
 * }
